...
import { extractMdxFrontmatter, extractMdxHeadings } from "mdxui/lib/mdx"
import { readContentMdx } from "mdxui/lib/content-mdx"
import {
  getContentSections,
  type ContentNavItem,
  type ContentSection,
} from "mdxui/lib/content-nav"
...
export async function MdxLayout({
  ...
  let relPath = isIndex ? "index" : segments.join("/")
