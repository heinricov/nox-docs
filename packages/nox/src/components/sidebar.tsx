...
import { useIsMobile } from "@nox/hooks/use-mobile"
import { cn } from "@nox/lib/utils"
import { Button } from "@nox/components/button"
import { Input } from "@nox/components/input"
...
import {
  ...
  SheetHeader,
  SheetTitle,
} from "@nox/components/sheet"
import { Skeleton } from "@nox/components/skeleton"
import {
  Tooltip,
  TooltipContent,
  TooltipTrigger,
} from "@nox/components/tooltip"
...
function Sidebar({
  ...
  return (
    <div
      className="group peer hidden text-sidebar-foreground data-[side=left]:pl-1 data-[side=right]:pr-1 md:block"
      data-state={state}
    ...
    >
      <div
        ...
        data-side={side}
        className={cn(
          "sticky top-0 z-10 hidden h-svh w-(--sidebar-width) transition-[left,right,width] duration-200 ease-linear data-[side=left]:left-0 data-[side=left]:group-data-[collapsible=offcanvas]:-left-(--sidebar-width) data-[side=left]:group-data-[collapsible=offcanvas]:w-0 data-[side=right]:right-0 data-[side=right]:group-data-[collapsible=offcanvas]:-right-(--sidebar-width) data-[side=right]:group-data-[collapsible=offcanvas]:w-0 md:flex",
